...
export class PortfolioComponent implements OnInit {
  ...
  works:any=[
    ...
    // { name:' Management',subtitle:'multiple user role based ' ,catagory:'web' ,image:'../../../assets/img/project/web4.png', language:['Laravel8', 'Jquery','Bootstrap', 'Html' , 'Css' ] , git: "https://github.com/mizan8102/InventoryJQueryLaravel"},
